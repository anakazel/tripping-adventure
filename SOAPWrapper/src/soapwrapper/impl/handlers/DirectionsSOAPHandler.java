 ...
 */
public final class DirectionsSOAPHandler extends AbstractSOAPHandler implements SOAPHandler<SOAPMessageContext> {

    private static final RestHttpClient REST_HTTP_CLIENT = new RestHttpClient(DIRECTIONS_URL);
    private static final String RESPONSE_NODE_NAME = "DirectionsResponse";
    ...
    public boolean handleMessage(SOAPMessageContext context) {
        ...
        try {
            ...
            if (outbound) {
                ...
                mode = soapBody.getElementsByTagName("mode").item(0).getTextContent();
            }
